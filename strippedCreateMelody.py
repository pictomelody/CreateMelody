...
def main(scale, major):
    ...
    while x < width:
        while y < height:
            ...
            region_triad = (major_triad(region_note) if major
                            else minor_triad(region_note))[0:random.randint(1, 3)]
